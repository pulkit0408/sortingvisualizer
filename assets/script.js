...
function swap(a, b) {
    ...
    var t1 = h1.substring(0,h1.length-2); 
    var t2 = h2.substring(0,h2.length-2); 
...
$(document).ready(function() {
    ...
    $("#apply-user-input").click(function() {
        let userInput = $("#user-input").val().trim();
        let inputArray = userInput.split(',').map(num => parseInt(num));
